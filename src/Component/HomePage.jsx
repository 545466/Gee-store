          ...
          return(
            <div className='bg-Gray shadow mt-10 ' key={Products.id} >
              <Link to={`/ProductDetail/${Products.id.toLowerCase()}`}>
                  <img className="w-full lg:h-[18rem] h-40 object-cover" src={Products.photoURL} alt="product imag" />
                </Link>
              <div className='grid pt-5 '>
              <h1 className='font-semibold px-2 lg:text-[1rem] text-[.8rem]'>{Products.Title}</h1>
